...
<script>
// Mantém o script igual, apenas muda o template e estilo
const fullBioMap = {
...
.user-profile-screen {
  display: flex;
  /* Removemos cálculos complexos de altura pq agora está dentro do dashboard */
  height: 100%;
  align-items: flex-start;
  justify-content: center;
  background-color: var(--bg-beige);
  padding: 40px 20px 80px 20px; /* Ajustado padding esquerdo */
}
